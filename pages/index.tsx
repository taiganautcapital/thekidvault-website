      ...
      <div style={{ background: C.cream }}>
        ...
        <footer style={{ background: C.navy, color: "rgba(255,255,255,0.4)", padding: "32px 24px", textAlign: "center", fontFamily: "'Trebuchet MS',sans-serif", fontSize: 13 }}>
          ...
          <div style={{ marginTop: 16, marginBottom: 8 }}>
            <a
              href="https://www.pinterest.com/thekidvault/"
              target="_blank"
              rel="noopener noreferrer"
              style={{ display: "inline-flex", alignItems: "center", gap: 7, color: "rgba(255,255,255,0.6)", textDecoration: "none", fontSize: 13, padding: "6px 14px", borderRadius: 20, border: "1px solid rgba(255,255,255,0.12)", transition: "all 0.2s ease" }}
              onMouseEnter={e => { const el = e.currentTarget; el.style.background = "rgba(230,0,35,0.15)"; el.style.borderColor = "rgba(230,0,35,0.4)"; el.style.color = "#fff"; }}
              onMouseLeave={e => { const el = e.currentTarget; el.style.background = "transparent"; el.style.borderColor = "rgba(255,255,255,0.12)"; el.style.color = "rgba(255,255,255,0.6)"; }}
            >
              <svg width="15" height="15" viewBox="0 0 24 24" fill="#E60023" xmlns="http://www.w3.org/2000/svg">
